...
description: "Claude's system prompt says 'try the simplest approach first.' That's good advice for a single decision. It's terrible advice for a project. What happens when nobody's left to know the difference?"
pubDate: 2026-04-08
