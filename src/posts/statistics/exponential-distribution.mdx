...
The exponential distribution is one of the most important probability distributions in operations research and simulation. It models the time between independent events that occur at a constant average rate. Examples: how long until the next customer arrives, how long until a machine fails, or how long until a radioactive atom decays.
...
- **Wait times.** After arriving at a clinic, patients are seen at a rate of $\lambda = 12$ per hour. The average wait time for a patient is 5 minutes.
