...
<Alert type="info">
  This problem is nearly identical to{" "}
  <a href="/posts/leetcode/maximum-average-subarray-i/">
    Maximum Average Subarray I
  </a>
  , but instead of calculating averages, we are counting vowels in substrings.
</Alert>
