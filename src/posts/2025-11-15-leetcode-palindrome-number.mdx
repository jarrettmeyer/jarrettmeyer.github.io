...
date: 2025-11-15
description: Given an integer, return True if it is a palindrome.
tags:
  - LeetCode
  - Python
thumbnail:
  src: /images/LeetCode_logo_black.png
  alt: LeetCode Logo
---
...
This has a very easy Python solution. Since the string operations in Python are highly optimized, this solution performs very well. Convert the integer to a string and compare it to its reverse.
